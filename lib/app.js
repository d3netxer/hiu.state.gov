...
var goToProduct = function (obj) {
      ...
      //product hash, so don't draw newProducts layer
      hashExists = true;
...
*/
  ...
  legend.onAdd = function (map) {
      ...
      div.innerHTML = '<div id="new-products-legend-outer-div"><div class="new-products-legend circleBase type-new" id="new-products-legend"></div><div class= "new-products-legend new-product-text" style="padding-left:5px;"> New Products</div></div><div id="new-global-products-legend-outer-div"><div class="new-products-legend fa fa-globe-new type-fa" id="new-products-legend"></div><div class= "new-products-legend new-product-text" style="padding-left:5px;"> New Global Products</div></div>';
  ...
  $(document).ready(function() {
      ...
      getArray().done( function(json) {
          ...
          for (var i in features) {
              ...
              if (map.getZoom() < 4 ) {
                  console.log('adding newProducts, zoom less than 4');
